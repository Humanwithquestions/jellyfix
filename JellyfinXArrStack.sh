...
# JellyfinXArrStack - Media Server Setup
# User: Boss
...
echo "JellyfinXArrStack setup finished."
echo "Disk mounts on boot. Auto-login enabled. Firewall active. Updates automatic."
